...
// en éxito, así que la única forma de avisar "se guardó" es una marca en la
// URL de destino (?saved=created|updated|deleted) que este componente lee
// una vez y limpia, sin agregar entrada al history.
...
export default function SavedToast() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[200] flex items-center gap-2.5 bg-zinc-900 text-white text-sm font-bold px-4 py-3 rounded-lg shadow-lg animate-[dashboard-toast-in_0.25s_ease-out]">
