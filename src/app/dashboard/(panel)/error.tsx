...
// del sitio público) y ofrece volver al inicio del panel.
      ...
      <div className="text-center max-w-md">
        ...
        <div className="flex items-center justify-center gap-3">
          <button
            type="button"
            onClick={() => reset()}
            className="px-4 py-2 rounded-lg bg-gold text-on-gold text-sm font-medium hover:brightness-95 transition-all"
          >
            Reintentar
          </button>
          <Link
